...
/* prior inverse variance of SBC vector, in Q11. Currently priors exist for
 MFCC[0-9] and delta_MFCC[0-9] */

const short MAX_DIM_SBC_STATIC = 9;
const short MAX_DIM_SBC_DELTA = 9;
