...
/*----------------------------------------------------------------
 ...
 Now loads *.olmdtpm
 ----------------------------------------------------------------*/
static TIesrDT_Error_t LoadTreeFile( TIesrDT_t aTIesrDT, unsigned char aChar )
{
   unsigned char treeFile[MAX_FILENAME];
   int treeBytes;
   size_t numRead;
   FILE* fp;
...
/*-----------------------------------------------------------------
 ...
 attribute.
 ------------------------------------------------------------------*/
static TIesrDT_Error_t GetTreeFileName( TIesrDT_t aTIesrDT, unsigned char aChar, unsigned char* aFileName )
{
   int isSpecial;
   int chrIndex;
   int pos;
...
#ifdef DEV_OFFSET
// read *.olmdtpm
static TIesrDT_Error_t  GetDTPhoneIndex( TIesrDT_t aTIesrDT, unsigned char aChar,
const unsigned char* aContext,
