 ...
 * gmhmm_type.h
 *
 * Header for TIesr data instance.
 *
...
*/
  ...
  */
  ...
  MODEL_PRUNE_type* pPhoneLevelPrune; /* pointer to the phone-level pruning structure */
  ...
  */
  NssType* pNss; /* pointer to noise subtraction data structure */ 

  short cm_score; /* confidence score of the current recognition result, in Q6 */
  ConfType * pConf; /* pointer to the confidence measure data structure */

  /* for force alignment */
  TransType *trans_bk;   /* backup symbol network */
  short     *base_net_bk;
  short nbr_ans_bk; 
  short answer_bk[MAX_WORD_UTT];
