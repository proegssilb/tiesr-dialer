 ...
 * Code Modifications to load Functions by Michael Schuster
...
#include <csl_types.h>
typedef Uint32 pMemory;
#else
typedef unsigned short Uint16;
typedef unsigned int Uint32;
typedef int Int32;
typedef short* pMemory;
#endif 
...
// Undefining the macros below can remove the associated processing steps.

// Currently enable only RAPID_JAC for TIesrLite.
//#undef OFFLINE_CLS
//#undef RAPID_JAC
...
// You have tp implement also this defined in load_user.h
